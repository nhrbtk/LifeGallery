...
namespace LG.BLL.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<bool> IsInRole(string id, string role)
        {
            ...
            ApplicationRole applicationRole = await Database.RoleManager.FindByNameAsync(role);
            if (user == null || applicationRole == null)
                return false;
            return await Database.UserManager.IsInRoleAsync(id, role);
        }
